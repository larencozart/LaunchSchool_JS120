...
3. Move all the other methods from the factory function into the constructor's
   prototype.
...
function Human() {
  Player.call(this); // inherits from player while using human as context
}
